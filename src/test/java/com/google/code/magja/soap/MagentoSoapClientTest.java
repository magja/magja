...
public class MagentoSoapClientTest {
	...
	/**
	 * In order to run this test, you have to setup three magento instances, and fill the api key and user
	 * and host as show in soap config
	 * This tests if the magentoSoapClient instances its exactly the same instances as created before
	 * @throws Exception
	 */
	@Test
