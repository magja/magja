...
public class CustomerFilter implements Serializable {
	...
	private static final long serialVersionUID=-3928174333216515623L;

	private List<CustomerFilterItem> items = new ArrayList<CustomerFilterItem>();
	...
	public Object serializeToApi() {
		...
		for (CustomerFilterItem item : items) {
	 ...
	 */
	public void setItems(List<CustomerFilterItem> items) {
		this.items = items;
	}
