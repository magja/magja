...
public class ProductLink extends BaseMagentoModel<Map<String, Object>> {
  ...
  public enum LinkType {
    ...
    public static LinkType getValueOfString(String linkType) {
      if (linkType.equals(RELATED.toString().toLowerCase()))
        return RELATED;
      else if (linkType.equals(UP_SELL.toString().toLowerCase()))
        return UP_SELL;
      else if (linkType.equals(CROSS_SELL.toString().toLowerCase()))
        return CROSS_SELL;
      else if (linkType.equals(GROUPED.toString().toLowerCase()))
        return GROUPED;
      else
        return null;
    }
