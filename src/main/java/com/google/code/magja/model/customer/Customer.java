...
public class Customer extends BaseMagentoModel {
  ...
  public String toString() {
    return "Customer [createdAt=" + createdAt + ", email=" + email + ", firstName=" + firstName + ", gender=" + gender + ", groupId=" + groupId + ", lastName="
        + lastName + ", middleName=" + middleName + ", password=" + password + ", passwordHash=" + passwordHash + ", prefix=" + prefix + ", storeId=" + storeId
        + ", suffix=" + suffix + ", websiteId=" + websiteId + ", id=" + id + ", properties=" + properties + "]";
  }
