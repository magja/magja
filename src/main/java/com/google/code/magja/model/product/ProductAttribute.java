...
public class ProductAttribute extends BaseMagentoModel<Object[]> {
  ...
  public Object[] serializeToApi() {
     ...
     * create a attribute, the type property means varchar, int, etc, and the
     * input is text, textarea, select, etc. so, we have to work workaround that
     * here, thats because we didnt put the input mapping on the mapping file
     */
    if (input != null)
  ...
  /**
   * @param visibleInAdvancedSearch
   *          the visibleInAdvancedSearch to set
   */
  ...
  public int hashCode() {
    ...
    result = prime * result + ((attributeClass == null) ? 0 : attributeClass.hashCode());
    ...
    result = prime * result + ((userDefined == null) ? 0 : userDefined.hashCode());
    result = prime * result + ((visible == null) ? 0 : visible.hashCode());
    result = prime * result + ((visibleInAdvancedSearch == null) ? 0 : visibleInAdvancedSearch.hashCode());
    result = prime * result + ((visibleOnFront == null) ? 0 : visibleOnFront.hashCode());
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (visibleInAdvancedSearch == null) {
      if (other.visibleInAdvancedSearch != null)
        return false;
    } else if (!visibleInAdvancedSearch.equals(other.visibleInAdvancedSearch))
      return false;
  ...
  public String toString() {
    return "ProductAttribute [applyTo=" + applyTo + ", attributeClass=" + attributeClass + ", backend=" + backend + ", code=" + code + ", comparable="
        + comparable + ", defaultValue=" + defaultValue + ", filterable=" + filterable + ", frontend=" + frontend + ", group=" + group + ", input=" + input
        + ", label=" + label + ", options=" + options + ", required=" + required + ", scope=" + scope + ", searchable=" + searchable + ", sortBy=" + sortBy
        + ", source=" + source + ", type=" + type + ", unique=" + unique + ", userDefined=" + userDefined + ", visible=" + visible
        + ", visibleInAdvancedSearch=" + visibleInAdvancedSearch + ", visibleOnFront=" + visibleOnFront + ", configurable=" + configurable + ", id=" + id
