...
public class ProductType {
  ...
  public static ProductType getType(String code) {
    if (code.equals(SIMPLE.getCode()))
      return SIMPLE;
    else if (code.equals(GROUPED.getCode()))
      return GROUPED;
    else if (code.equals(CONFIGURABLE.getCode()))
      return CONFIGURABLE;
    else if (code.equals(VIRTUAL.getCode()))
      return VIRTUAL;
    else if (code.equals(BUNDLE.getCode()))
      return BUNDLE;
    else if (code.equals(DOWNLOADABLE.getCode()))
      return DOWNLOADABLE;
  ...
  public String toString() {
    return "ProductType [name=" + name + ", code=" + code + "]";
  }
