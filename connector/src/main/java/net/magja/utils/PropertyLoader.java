...
public class PropertyLoader {
   ...
   * @param loader
   *          classloader through which to load the resource [null is equivalent
  ...
  /**
   * A convenience overload of {@link #loadProperties(String, ClassLoader)} that
   * uses the current thread's context classloader. A better strategy would be
   * to use techniques shown in
