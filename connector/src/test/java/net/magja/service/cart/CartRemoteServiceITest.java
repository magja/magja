package net.magja.service.cart;
...
import net.magja.model.cart.Cart;
import net.magja.model.cart.CartAddress;
import net.magja.model.cart.CartLicense;
import net.magja.model.cart.CartTotal;
