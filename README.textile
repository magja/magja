...
h2. Continuous Integration Build

Magja automated integration builds are provided here:

https://buildhive.cloudbees.com/job/magja/job/magja/

Continuous Integration service provided by "CloudBees":http://www.cloudbees.com/.
